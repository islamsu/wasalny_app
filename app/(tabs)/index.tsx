...
const styles = StyleSheet.create({
  ...
  sectionSubtitle: { fontSize: 12, marginTop: 4, textAlign: "right" }, nearbyCard: { borderWidth: 1, borderRadius: 20, padding: 14, gap: 10 }, linkText: { fontSize: 10, fontWeight: "800" }, favoriteRequest: { flex: 1, flexDirection: "row-reverse", alignItems: "center", gap: 10 }, favoriteRemove: { paddingHorizontal: 6, paddingVertical: 8 }, nearbyRow: { borderTopWidth: 1, paddingTop: 11, flexDirection: "row-reverse", alignItems: "center", gap: 10 }, driverIcon: { fontSize: 25 }, driverName: { fontSize: 13, fontWeight: "800", textAlign: "right" }, driverMeta: { fontSize: 10, marginTop: 3, textAlign: "right" }, driverCopy: { flex: 1, alignItems: "flex-end" }, driverEta: { fontSize: 13, fontWeight: "800" },
  wave: { fontSize: 25 },
  actions: { gap: 10 },
